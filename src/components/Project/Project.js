    ...
    <div className='project-section'>
        ...
        <div className='projects'>
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title text-info">E-commrce</h5>
        ...
        <img src="./assets/maaloum_blog.png" class="card-img-top" alt="..."/>
            <div class="card-body">
                <h5 class="card-title text-info">Maaloum Blog</h5>
                ...
                <a href="https://main--super-paletas-b4ba8a.netlify.app/" target="_blank"  class="btn btn-info">Go Live</a>
            </div>
        </div>
        <div class="card">
        <img src="./assets/shopping_card.png" class="card-img-top" alt="..."/>
            <div class="card-body">
                <h5 class="card-title text-info">Shopping Cart</h5>
                ...
                <a href="#" target="_blank"  class="btn btn-info">Go Live</a>
            </div>
        </div>
        <div class="card">
        <img src="./assets/country_info.png" class="card-img-top" alt="..."/>
            <div class="card-body">
                <h5 class="card-title text-info">Country Info</h5>
